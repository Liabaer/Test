...
from learn_pytest.test_ordering.ordering_model.admin import Admin
from learn_pytest.test_ordering.ordering_model.customer import Customer
from learn_pytest.test_ordering.ordering_service.admin_service import AdminService
from learn_pytest.test_ordering.ordering_service.audit_service import AuditService
from learn_pytest.test_ordering.ordering_service.customer_service import CustomerService
from learn_pytest.test_ordering.ordering_model.shop import Shop
from learn_pytest.test_ordering.ordering_service.order_service import OrderService
from learn_pytest.test_ordering.ordering_service.shop_service import ShopService
...
def create_shop():
    ...
    shop = Shop(name=name, password=password, status=status, review_score_avg=review_score_avg,
